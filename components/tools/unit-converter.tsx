...
export default function UnitConverter() {
  ...
  const conversionFactors: Record<string, Record<string, number>> = {
    ...
    ms: {
      ...
      day: 0.00000001157,
      week: 0.00000000165,
      month: 0.00000000038, // 30일 기준
      year: 0.00000000003, // 365일 기준
    },
    s: {
      ms: 1000,
      s: 1,
      ...
      day: 0.0000115741,
      week: 0.00000165344,
      month: 0.000000380517, // 30일 기준
      year: 0.0000000317098, // 365일 기준
    },
    min: {
      ms: 60000,
      s: 60,
      ...
      day: 0.000694444,
      week: 0.0000992063,
      month: 0.0000228154, // 30일 기준
      year: 0.00000190259, // 365일 기준
    },
    h: {
      ms: 3600000,
      s: 3600,
      ...
      day: 0.0416667,
      week: 0.00595238,
      month: 0.00136986, // 30일 기준
      year: 0.000114155, // 365일 기준
    },
    day: {
      ms: 86400000,
      s: 86400,
      ...
      day: 1,
      week: 0.142857,
      month: 0.0328767, // 30일 기준
      year: 0.00273973, // 365일 기준
    },
    week: {
      ms: 604800000,
      s: 604800,
      ...
      day: 7,
      week: 1,
      month: 0.229978, // 30일 기준
      year: 0.0191781, // 365일 기준
    },
    month: {
      ms: 2592000000, // 30일 기준
      s: 2592000,
      min: 43200,
      h: 720,
      day: 30,
